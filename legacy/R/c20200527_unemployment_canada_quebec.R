...
pp <- ShadeBars2(ur_can, ur_qc,  recession,  
                 ...
                 startdate='1997-01-01', legend=c('Canada-Wide', 'Quebec'),
                 legendhead = 'Unemployment Rate (NSA)')
pp <- SetXAxis(pp, "1997-01-01", 4)


OnePanelChart(pp, "c20200527_unemployment_canada_quebec.png","*Shade represents recessions (C.D. Howe). Source: Statscan.")
