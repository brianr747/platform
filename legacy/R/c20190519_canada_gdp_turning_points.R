...
pp <- RecBars(ser["1990-0101/"], turning_indic["1990-01-01/"], 
...
p2 <- RecBars(ser["1990-0101/"], recession["1990-01-01/"], 
...
p3 <- RecBars(UR["1990-0101/"], recession["1990-01-01/"], 
...
UR_rise = UR - URmin
p4 <- RecBars(UR_rise["1990-01-01/"], recession["1990-01-01/"], 
...
p5 <- RecBars(target_rate["1993-01-01/"], recession["1993-01-01/"], 
...
# UR Rise versus OECD
p6 <- RecBars(UR_rise["1990-01-01/"], turning_indic["1990-01-01/"], 
